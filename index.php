...
<div class = "mainindex">
    <div class= "middle">
        ...
        <br>
        <form name ="subForm" class="form-horizontal" action = "php/extraInstructions.php" method = "POST">
            <fieldset>
                <div class="form-group" id ="indexForm">
                    <label for="codeInput">Code</label><br>
                    <input type="text" name="codeInput" id="codeInput" autocomplete="off"/>
                </div>
                <div class="form-group" id ="indexForm" >
                    <label for="codeInput">Full Name: </label><br>
                    <input type="text" name="nameInput" id="nameInput" autocomplete="off"/>
                </div>
                <div class="form-group" id ="indexForm">
